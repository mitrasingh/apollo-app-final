...
const EditTaskPage = () => {
    ...
    return (
        <Container className={`text-light fs-6 px-4 ${styles.formContainer}`}>
            <p className="fs-2 mb-4 fw-bold d-flex justify-content-center text-light">Edit Your Task</p>
            <ErrorBoundary FallbackComponent={ErrorFallbackProfile}>
                <EditTaskForm task={task} creatorName={creatorName} creatorPhoto={creatorPhoto} />
            </ErrorBoundary>
        </Container>
    )
};
